...
To try it, delete all the code in `src/App.js` and replace it with any of the examples on its website. The [Basic ShelfSelectorDropdown](https://reacttraining.com/react-router/web/example/basic) is a good place to get started.
...
ShelfSelectorDropdown package.json:
...
```sh
    ...
    ? What Firebase project do you want to associate as default? ShelfSelectorDropdown app (example-app-fd690)
